...
//  info: { type: String, label: "Additional informations", max: 400, optional: true },
//  fromLoc: { type: [Number], label: "FromLoc", decimal: true, index: "2dsphere" },
//  toLoc: { type: [Number], label: "ToLoc", decimal: true, index: "2dsphere" },
...
//  activated: { type: Boolean, label: "Activation", defaultValue: false },
